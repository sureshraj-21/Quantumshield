...
def calculate_cps(prices):
    ...
    correlation_values = correlation_matrix.values[np.triu_indices_from(
    ...
    # Scale to CPS metric (0-2 range typical)
    # Convert from correlation range [-1, 1] to stress metric
